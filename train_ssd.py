...
# from vision.ssd.efficient_ssd_lite import create_mobilenetv2_ssd_lite
...
def evaluate(loader, net, criterion, device):
    net.eval()
    running_loss = 0.0
    running_regression_loss = 0.0
    running_classification_loss = 0.0
...
if __name__ == '__main__':
    ...
    for epoch in range(last_epoch + 1, args.num_epochs):
        ...
        if epoch % args.validation_epochs == 0 or epoch == args.num_epochs - 1:
            val_loss, val_regression_loss, val_classification_loss = evaluate(val_loader, net, criterion, DEVICE)
            logging.info(
                f"Epoch: {epoch}, " +
